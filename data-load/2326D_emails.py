...
# account credentials
username = 'sailbuoypimpim@gmail.com'
password = 'snvaqegzzstpoynv'
...
if os.path.isfile('../data/SB2326D.csv') == False:
        ...
        if isinstance(response, tuple):
            ...
            if From == 'data@sailbuoy.no':
                ...
                if i == 1: # Save the first instant to have a starting point
                    df.to_csv('../data/SB2326D.csv')
                
                else:
                    df.to_csv('../data/SB2326D_latest.csv')
                    
                    latest = pd.read_csv('../data/SB2326D_latest.csv')
                    full = pd.read_csv('../data/SB2326D.csv')
